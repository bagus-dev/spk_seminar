        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('admin/dashboard/field_seminar/save') ?>" method="post">
                            <?= csrf_field() ?>

                            <div class="form-group">
                                <label for="name">Nama Bidang</label>
                                <input type="text" name="name" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : '' ?>" placeholder="Nama Bidang" value="<?= old('name') ?>">
