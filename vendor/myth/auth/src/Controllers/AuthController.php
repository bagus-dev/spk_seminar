...
class AuthController extends Controller
{
	...
	public function attemptLogin()
	{
		...
		if(in_groups('admin')) {
			...
			$redirectURL = site_url('/student/dashboard');
		}

		return redirect()->to($redirectURL)->withCookies()->with('success', lang('Auth.loginSuccess'));
	}
	...
	public function register()
	{
		...
		return $this->_render($this->config->views['register'], ['config' => $this->config, 'title' => 'Daftar Akun']);
	}
